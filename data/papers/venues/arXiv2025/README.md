...
## [AI Software Engineer: Programming with Trust](paper_16.md)
...
## [Automated Static Vulnerability Detection via a Holistic Neuro-symbolic Approach](paper_13.md)
...
## [C2SaferRust: Transforming C Projects into Safer Rust with NeuroSymbolic Techniques](paper_20.md)
...
## [Can LLMs Reason About Program Semantics? A Comprehensive Evaluation of LLMs on Formal Specification Inference](paper_9.md)
...
## [ClassInvGen: Class Invariant Synthesis using Large Language Models](paper_12.md)
...
## [Combining Large Language Models with Static Analyzers for Code Review Generation](paper_11.md)
...
## [Evaluating the Effectiveness of Small Language Models in Detecting Refactoring Bugs](paper_10.md)
- **Authors**: Rohit Gheyi, Marcio Ribeiro, Jonhnanthan Oliveira
...
## [Fixing 7,400 Bugs for 1$: Cheap Crash-Site Program Repair](paper_14.md)
...
## [From System 1 to System 2: A Survey of Reasoning Large Language Models](paper_17.md)
...
## [Hierarchical Repository-Level Code Summarization for Business Applications Using Local LLMs](paper_19.md)
...
## [Interactive Tools Substantially Assist LM Agents in Finding Security Vulnerabilities](paper_15.md)
...
## [Is Your Benchmark (Still) Useful? Dynamic Benchmarking for Code Language Models](paper_7.md)
...
## [KNighter: Transforming Static Analysis with LLM-Synthesized Checkers](paper_8.md)
...
## [Large Language Model powered Symbolic Execution](paper_18.md)
