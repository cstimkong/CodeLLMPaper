...
## [AI Software Engineer: Programming with Trust](paper_15.md)
...
## [Automated Static Vulnerability Detection via a Holistic Neuro-symbolic Approach](paper_12.md)
...
## [C2SaferRust: Transforming C Projects into Safer Rust with NeuroSymbolic Techniques](paper_19.md)
...
## [Can LLMs Reason About Program Semantics? A Comprehensive Evaluation of LLMs on Formal Specification Inference](paper_8.md)
...
## [ClassInvGen: Class Invariant Synthesis using Large Language Models](paper_11.md)
...
## [Combining Large Language Models with Static Analyzers for Code Review Generation](paper_10.md)
...
## [Evaluating the Effectiveness of Small Language Models in Detecting Refactoring Bugs](paper_9.md)
- **Authors**: Rohit Gheyi, Marcio Ribeiro, Jonhnanthan Oliveira
...
## [Fixing 7,400 Bugs for 1$: Cheap Crash-Site Program Repair](paper_13.md)
...
## [From System 1 to System 2: A Survey of Reasoning Large Language Models](paper_16.md)
...
## [Hierarchical Repository-Level Code Summarization for Business Applications Using Local LLMs](paper_18.md)
...
## [Interactive Tools Substantially Assist LM Agents in Finding Security Vulnerabilities](paper_14.md)
...
## [Is Your Benchmark (Still) Useful? Dynamic Benchmarking for Code Language Models](paper_6.md)
...
## [KNighter: Transforming Static Analysis with LLM-Synthesized Checkers](paper_7.md)
...
## [Large Language Model powered Symbolic Execution](paper_17.md)
...
## [Training Language Models to Generate Quality Code with Program Analysis Feedback](paper_5.md)
