...
## [AI Software Engineer: Programming with Trust](paper_17.md)
...
## [Automated Static Vulnerability Detection via a Holistic Neuro-symbolic Approach](paper_14.md)
...
## [C2SaferRust: Transforming C Projects into Safer Rust with NeuroSymbolic Techniques](paper_21.md)
...
## [CRUST-Bench: A Comprehensive Benchmark for C-to-safe-Rust Transpilation](paper_5.md)
...
## [Can LLMs Reason About Program Semantics? A Comprehensive Evaluation of LLMs on Formal Specification Inference](paper_10.md)
...
## [ClassInvGen: Class Invariant Synthesis using Large Language Models](paper_13.md)
...
## [Combining Large Language Models with Static Analyzers for Code Review Generation](paper_12.md)
...
## [Evaluating the Effectiveness of Small Language Models in Detecting Refactoring Bugs](paper_11.md)
- **Authors**: Rohit Gheyi, Marcio Ribeiro, Jonhnanthan Oliveira
...
## [Fixing 7,400 Bugs for 1$: Cheap Crash-Site Program Repair](paper_15.md)
...
## [From System 1 to System 2: A Survey of Reasoning Large Language Models](paper_18.md)
...
## [Hierarchical Repository-Level Code Summarization for Business Applications Using Local LLMs](paper_20.md)
...
## [Interactive Tools Substantially Assist LM Agents in Finding Security Vulnerabilities](paper_16.md)
...
## [Is Your Benchmark (Still) Useful? Dynamic Benchmarking for Code Language Models](paper_8.md)
...
## [KNighter: Transforming Static Analysis with LLM-Synthesized Checkers](paper_9.md)
...
## [LAMD: Context-driven Android Malware Detection and Classification with LLMs](paper_3.md)
...
## [Language Models for Code Optimization: Survey, Challenges and Future Directions](paper_4.md)
...
## [Large Language Model powered Symbolic Execution](paper_19.md)
...
## [Minimizing False Positives in Static Bug Detection via LLM-Enhanced Path Feasibility Analysis](paper_7.md)
...
## [SecVulEval: Benchmarking LLMs for Real-World C/C++ Vulnerability Detection](paper_1.md)
...
## [The Hitchhiker's Guide to Program Analysis, Part II: Deep Thoughts by LLMs](paper_2.md)
...
## [Training Language Models to Generate Quality Code with Program Analysis Feedback](paper_6.md)
