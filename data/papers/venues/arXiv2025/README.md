...
## [AI Software Engineer: Programming with Trust](paper_11.md)
...
## [C2SaferRust: Transforming C Projects into Safer Rust with NeuroSymbolic Techniques](paper_13.md)
...
## [CVE-Bench: A Benchmark for AI Agents' Ability to Exploit Real-World Web Application Vulnerabilities](paper_10.md)
...
## [Can LLMs Reason About Program Semantics? A Comprehensive Evaluation of LLMs on Formal Specification Inference](paper_6.md)
...
## [ClassInvGen: Class Invariant Synthesis using Large Language Models](paper_9.md)
...
## [Combining Large Language Models with Static Analyzers for Code Review Generation](paper_8.md)
...
## [Evaluating the Effectiveness of Small Language Models in Detecting Refactoring Bugs](paper_7.md)
- **Authors**: Rohit Gheyi, Marcio Ribeiro, Jonhnanthan Oliveira
...
## [Hierarchical Repository-Level Code Summarization for Business Applications Using Local LLMs](paper_12.md)
...
## [Is Your Benchmark (Still) Useful? Dynamic Benchmarking for Code Language Models](paper_4.md)
...
## [KNighter: Transforming Static Analysis with LLM-Synthesized Checkers](paper_5.md)
