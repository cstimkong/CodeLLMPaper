...
## [A Survey on Large Language Models for Code Generation](paper_8.md)
...
## [Automatic Programming: Large Language Models and Beyond](paper_10.md)
...
## [CodeBenchGen: Creating Scalable Execution-based Code Generation Benchmarks](paper_7.md)
...
## [Codemind: A framework to challenge large language models for code reasoning](paper_4.md)
...
## [Constrained Decoding for Secure Code Generation](paper_5.md)
...
## [Enabling Memory Safety of C Programs using LLMs](paper_12.md)
...
## [EvoCodeBench: An Evolving Code Generation Benchmark Aligned with Real-World Code Repositories](paper_6.md)
...
## [LLM4Vuln: {A} Unified Evaluation Framework for Decoupling and Enhancing LLMs' Vulnerability Reasoning](paper_17.md)
...
## [Large Language Models Based Fuzzing Techniques: A Survey](paper_37.md)
...
## [Rectifier: Code translation with corrector via llms](paper_11.md)
...
## [Repairagent: An autonomous, llm-based agent for program repair](paper_9.md)
...
## [Source Code Vulnerability Detection: Combining Code Language Models and Code Property Graphs](paper_15.md)
...
## [Top Score on the Wrong Exam: On Benchmarking in Machine Learning for Vulnerability Detection](paper_18.md)
...
## [VulEval: Towards Repository-Level Evaluation of Software Vulnerability Detection](paper_13.md)
...
## [Your Instructions Are Not Always Helpful: Assessing the Efficacy of Instruction Fine-tuning for Software Vulnerability Detection](paper_16.md)
