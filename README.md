...
- [General Coding Task](data/papers/labels/general_coding_task.md)   (34)
- [Code Generation](data/papers/labels/code_generation.md)   (249)
  - [Program Synthesis](data/papers/labels/program_synthesis.md)   (97)
  - [Code Completion](data/papers/labels/code_completion.md)   (24)
  - [Program Repair](data/papers/labels/program_repair.md)   (60)
  - [Program Transformation](data/papers/labels/program_transformation.md)   (40)
- [Program Testing](data/papers/labels/program_testing.md)   (85)
  - [General Testing](data/papers/labels/general_testing.md)   (3)
  - [Fuzzing](data/papers/labels/fuzzing.md)   (29)
  - [Library Testing](data/papers/labels/library_testing.md)   (4)
  ...
  - [Unit Testing](data/papers/labels/unit_testing.md)   (10)
...
- [Static Analysis](data/papers/labels/static_analysis.md)   (195)
  ...
  - [Code Similarity Analysis](data/papers/labels/code_similarity_analysis.md)   (7)
  - [Bug Detection](data/papers/labels/bug_detection.md)   (100)
  ...
  - [Program Decompilation](data/papers/labels/program_decompilation.md)   (11)
  - [Code Summarization](data/papers/labels/code_summarization.md)   (16)
  - [Code Search](data/papers/labels/code_search.md)   (7)
  - [Software Composition Analysis](data/papers/labels/software_composition_analysis.md)   (3)
- [Software Maintenance and Deployment](data/papers/labels/software_maintenance_and_deployment.md)   (26)
  - [Code Review](data/papers/labels/code_review.md)   (8)
  - [Documentation Generation](data/papers/labels/documentation_generation.md)   (3)
...
- [Code Model](data/papers/labels/code_model.md)   (130)
  - [Code Model Training](data/papers/labels/code_model_training.md)   (87)
  ...
  - [Code Model Robustness](data/papers/labels/code_model_robustness.md)   (10)
- [Hallucination In Reasoning](data/papers/labels/hallucination_in_reasoning.md)   (14)
- [PL Design For LLMs](data/papers/labels/PL_design_for_LLMs.md)   (3)
- [Agent Design](data/papers/labels/agent_design.md)   (65)
...
- [Empirical Study](data/papers/labels/empirical_study.md)   (96)
