...
- [General Coding Task](data/papers/labels/general_coding_task.md)   (33)
- [Code Generation](data/papers/labels/code_generation.md)   (237)
  - [Program Synthesis](data/papers/labels/program_synthesis.md)   (92)
  - [Code Completion](data/papers/labels/code_completion.md)   (24)
  - [Program Repair](data/papers/labels/program_repair.md)   (58)
  - [Program Transformation](data/papers/labels/program_transformation.md)   (38)
- [Program Testing](data/papers/labels/program_testing.md)   (77)
  - [General Testing](data/papers/labels/general_testing.md)   (2)
  - [Fuzzing](data/papers/labels/fuzzing.md)   (28)
  - [Library Testing](data/papers/labels/library_testing.md)   (3)
  ...
  - [Unit Testing](data/papers/labels/unit_testing.md)   (8)
  - [Differential Testing](data/papers/labels/differential_testing.md)   (5)
  - [Debugging](data/papers/labels/debugging.md)   (14)
  - [Bug Reproduction](data/papers/labels/bug_reproduction.md)   (4)
  - [Vulnerability Exploitation](data/papers/labels/vulnerability_exploitation.md)   (11)
- [Static Analysis](data/papers/labels/static_analysis.md)   (184)
  ...
  - [Type Inference](data/papers/labels/type_inference.md)   (6)
  - [Specification Inference](data/papers/labels/specification_inference.md)   (20)
  - [Equivalence Checking](data/papers/labels/equivalence_checking.md)   (1)
  - [Code Similarity Analysis](data/papers/labels/code_similarity_analysis.md)   (6)
  - [Bug Detection](data/papers/labels/bug_detection.md)   (94)
  - [Program Verification](data/papers/labels/program_verification.md)   (26)
  ...
  - [Code Summarization](data/papers/labels/code_summarization.md)   (13)
  - [Code Search](data/papers/labels/code_search.md)   (6)
  - [Software Composition Analysis](data/papers/labels/software_composition_analysis.md)   (3)
- [Software Maintenance and Deployment](data/papers/labels/software_maintenance_and_deployment.md)   (21)
...
- [Code Model](data/papers/labels/code_model.md)   (128)
  - [Code Model Training](data/papers/labels/code_model_training.md)   (86)
  ...
  - [Code Model Security](data/papers/labels/code_model_security.md)   (30)
  - [Code Model Robustness](data/papers/labels/code_model_robustness.md)   (9)
...
- [Agent Design](data/papers/labels/agent_design.md)   (64)
...
- [Empirical Study](data/papers/labels/empirical_study.md)   (92)
